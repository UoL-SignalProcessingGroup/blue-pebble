...
# data before the detector can run at all. Operationally that is a survey of the ambient noise
...
# drawn independently of the scenario's. The calibration needs about 20,000 cells at its
