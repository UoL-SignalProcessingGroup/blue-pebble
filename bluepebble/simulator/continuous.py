...
from ..signal.anthropogenic.base import AnthropogenicSignalBase
...
class ContinuousSTFTPassiveSonarArraySimulator(PassiveSonarArraySimulatorBase):
    ...
    signal_models: list[AnthropogenicSignalBase] = Property(
    ...
    def _build_common_context(
        self,
        all_timestamps: list[datetime],
        signal_models_list: "list[AnthropogenicSignalBase]",
    ) -> _STFTCommonContext:
